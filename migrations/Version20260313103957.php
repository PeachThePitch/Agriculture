 ...
 */
final class Version20260313103957 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE element_chimique (id INT AUTO_INCREMENT NOT NULL, libelle_element VARCHAR(50) NOT NULL, unite_id INT NOT NULL, INDEX IDX_DD3A4BFAEC4A74AB (unite_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE parcelle (id INT AUTO_INCREMENT NOT NULL, surface DOUBLE PRECISION NOT NULL, nom VARCHAR(100) NOT NULL, coordonnees VARCHAR(50) NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
